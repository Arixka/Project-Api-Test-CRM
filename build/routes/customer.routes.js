...
router.post('/', [_checkAuth.checkToken, (0, _checkAuth.authorizedRole)('ADMIN', 'USER'), (0, _expressValidator.check)('name', 'Name is required').not().isEmpty(), (0, _expressValidator.check)('lastName', 'LastName is required').not().isEmpty(), (0, _expressValidator.check)('phone', 'Phone is required').not().isEmpty(), (0, _expressValidator.check)('phone').custom(_validationsMongodb.customerExist), (0, _expressValidator.check)('phone', 'Must be a phone number').isMobilePhone(), (0, _expressValidator.check)('image', 'Must upload an image').not().isEmpty(), _validateReq.validateReq], _customer.createCustomer);
